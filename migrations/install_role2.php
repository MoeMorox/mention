...
class install_role2 extends \phpbb\db\migration\migration
{
	...
	public function update_data()
	{
		...
		{
			$data[] = array('permission.permission_set', array('ROLE_USER_FULL', 'u_can_mention_groups'));
			$data[] = array('permission.permission_set', array('ROLE_USER_FULL', 'u_can_mention_large_groups'));
		}
